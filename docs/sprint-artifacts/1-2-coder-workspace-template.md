...
- [x] **Task 2: Create startup script** (AC: 2)
  ...
  - [x] 2.2 Add repo cloning logic (shtetl-infra, shtetl-api, shtetl-web, shtetl-mobile)
...
- [ ] **Task 3: Configure health check endpoints** (AC: 3)
  ...
  - [ ] 3.2 Test Zmanim service health check on port 8101
  - [ ] 3.3 Test Shul service health check on port 8103
  - [ ] 3.4 Test Kehilla service health check on port 8105
  - [ ] 3.5 Verify web app loads on port 8100
...
- Web Frontend: 8100
- Zmanim Service: 8101 (REST)
- Shul Service: 8103 (REST)
- Kehilla Service: 8105 (REST)
- PostgreSQL: 5432
- Redis: 6379
...
- GitHub repositories must exist: shtetl-infra, shtetl-api, shtetl-web, shtetl-mobile
